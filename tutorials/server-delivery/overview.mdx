...
<Steps>
  <Step title="Create the server integration">Open **Integrations > Servers**, click **Create Server**, and copy the token if the method uses one.</Step>
...
<Frame caption="Integrations > Servers lists every delivery connection of the store.">
  <img
    src="/images/tutorials/server-delivery/server-list.png"
    alt="Server integrations page with the create button and existing delivery connections highlighted"
  />
</Frame>

<CardGroup cols={2}>
  <Card title="Connect a server" icon="cable" href="/tutorials/server-delivery/connect-server">
    Create a server integration and protect its connection token.
  </Card>
  <Card title="Install the Minecraft executor" icon="/images/icons/games/minecraft.png" href="/tutorials/server-delivery/minecraft">
    Connect a Minecraft server or proxy to Gamecart command delivery.
  </Card>
  <Card title="Install the Hytale executor" icon="/images/icons/games/hytale.png" href="/tutorials/server-delivery/hytale">
    Connect a Hytale server to Gamecart command delivery.
  </Card>
  <Card title="Install the FiveM executor" icon="/images/icons/games/fivem.png" href="/tutorials/server-delivery/fivem">
    Connect a FiveM server resource to Gamecart command delivery.
  </Card>
  <Card title="Configure Minecraft RCON" icon="/images/icons/games/minecraft.png" href="/tutorials/server-delivery/minecraft-rcon">
    Connect Gamecart directly to a compatible Minecraft RCON server.
  </Card>
  <Card title="Configure product delivery commands" icon="square-terminal" href="/tutorials/server-delivery/configure-commands">
    Add server commands and select the product events that trigger them.
  </Card>
  <Card title="Test and troubleshoot server delivery" icon="life-buoy" href="/tutorials/server-delivery/troubleshooting">
