...
<Steps>
  ...
  <Step title="Run a controlled test">Place a controlled order, then [verify the command and troubleshoot delivery](/tutorials/server-delivery/troubleshooting).</Step>
</Steps>
