...
<CardGroup cols={2}>
  ...
  <Card title="Install the Minecraft executor" icon="grid-3x3" href="/tutorials/server-delivery/minecraft">
    Connect a Minecraft server or proxy to Gamecart command delivery.
  </Card>
  <Card title="Install the Hytale executor" icon="swords" href="/tutorials/server-delivery/hytale">
  ...
  <Card title="Configure Minecraft RCON" icon="terminal" href="/tutorials/server-delivery/minecraft-rcon">
