...
icon: "/images/icons/games/minecraft.png"
...
Download the current stable JAR for your runtime:

- [Spigot / Paper / Folia](https://cdn.gamecart.gg/executors/minecraft/latest/gamecart-spigot.jar)
- [BungeeCord](https://cdn.gamecart.gg/executors/minecraft/latest/gamecart-bungeecord.jar)
- [Velocity](https://cdn.gamecart.gg/executors/minecraft/latest/gamecart-velocity.jar)
- [Fabric 1.21.4](https://cdn.gamecart.gg/executors/minecraft/latest/gamecart-fabric-1.21.4.jar)
- [Fabric 1.21.11](https://cdn.gamecart.gg/executors/minecraft/latest/gamecart-fabric-1.21.11.jar)
- [Fabric 26.1](https://cdn.gamecart.gg/executors/minecraft/latest/gamecart-fabric-26.1.jar)
...
<Frame caption="Use the masked token from the exact Minecraft connection you are configuring.">
  <img
    ...
    alt="Minecraft server connection row with its masked token highlighted"
  />
</Frame>

Set `pollIntervalSeconds` to a value from `5` through `600`. Unless you are testing on loopback, `apiUrl` must use HTTPS. With `debug=true`, the executor logs sanitized state and status information. It does not log tokens, commands, player identifiers, HTTP bodies, buyer data, or order data.
