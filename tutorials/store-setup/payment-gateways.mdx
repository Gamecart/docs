...
<CardGroup cols={2}>
  <Card title="Stripe" icon="badge-dollar-sign" href="/tutorials/store-setup/payment-gateways/stripe">
  ...
  <Card title="Mercado Pago" icon="landmark" href="/tutorials/store-setup/payment-gateways/mercado-pago">
  ...
  <Card title="Pix (Efí)" icon="banknote" href="/tutorials/store-setup/payment-gateways/efi">
