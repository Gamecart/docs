...
<Steps>
  ...
  <Step title="Publish and test">
    Open the storefront, place a controlled test order, and [verify the delivery result](/tutorials/server-delivery/troubleshooting). Confirm that payment status, order details, and delivery behavior match the dashboard.
  </Step>
</Steps>
